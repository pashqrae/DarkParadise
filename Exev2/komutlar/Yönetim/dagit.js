...
module.exports.run = (client, message, args, durum, kanal) => {
    ...
    if (durum) {
      ...
      let publicRooms = message.guild.channels.cache.filter(c => c.parentID === client.ayarlar.PUBLIC_KATEGORI && c.id !== client.ayarlar.SLEEP_ROOM && c.id !== client.ayarlar.TAGLI_ROOM && c.type === "voice");
