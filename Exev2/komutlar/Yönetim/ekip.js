...
module.exports.run = async (client, message, args, durum, kanal) => {
    ...
    if (message.member.permissions.has(8) || durum || sunucuData.GKV.includes(message.author.id) || message.author.id == message.guild.owner.id || client.ayarlar.sahip.includes(message.author.id)) {
     return; 
       let sec = args[0];
